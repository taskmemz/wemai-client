...
class MenuItem_Control():
    def __init__(self,language=language,Version=Version):
        ...
        self.Version=Version
        if self.language=='简体中文':
            self.TickleMenuItem={'title':'拍一拍','control_type':'MenuItem'}
            ...
            self.DeleteMenuItem={'title':'删除','control_type':'MenuItem','auto_id':'XMenuItem'}
            ...
            self.CopyLinkMenuItem={'title':'复制链接','auto_id':'XMenuItem','control_type':'MenuItem'}
            self.VoiceToTextMenuItem={'title':'语音转文字','control_type':'MenuItem'}
        if self.language=='English':
            self.TickleMenuItem={'title':'Tickle','control_type':'MenuItem'}
            self.ForwardMenuItem={'title':'Forward...','control_type':'MenuItem'}
            self.CopyMenuItem={'title':'Copy','control_type':'MenuItem'}
            self.SaveMenuItem={'title':'Save as...','control_type':'MenuItem'}
            self.AddToFavoritesMenuItem={'title':'Add to Favorites','control_type':'MenuItem'}
            self.TranslateMenuItem={'title':'Translate','control_type':'MenuItem'}
            self.EditMenuItem={'title':'Edit','control_type':'MenuItem'}
            self.DeleteMenuItem={'title':'Delete','control_type':'MenuItem','auto_id':'XMenuItem'}
            self.SearchMenuItem={'title':'Search','control_type':'MenuItem'}
            self.QuoteMeunItem={'title':'Quote','control_type':'MenuItem'}
            self.SelectMenuItem={'title':'Select...','control_type':'MenuItem'}
            self.EnlargeMeunItem={'title':'Enlarge','control_type':'MenuItem'}
            self.FindInChatMenuItem={'title':'Find in Chat','control_type':'MenuItem'}
            self.CopyLinkMenuItem={'title':'Copy URL','auto_id':'XMenuItem','control_type':'MenuItem'}
            self.VoiceToTextMenuItem={'title':'Transcribe','control_type':'MenuItem'}
        if self.language=='繁體中文':
            self.TickleMenuItem={'title':'拍一拍','control_type':'MenuItem'}
            self.ForwardMenuItem={'title':'轉發...','control_type':'MenuItem'}
            self.CopyMenuItem={'title':'複製','control_type':'MenuItem'}
            self.SaveMenuItem={'title':'另存為...','control_type':'MenuItem'}
            self.AddToFavoritesMenuItem={'title':'收藏','control_type':'MenuItem'}
            self.TranslateMenuItem={'title':'翻譯','control_type':'MenuItem'}
            self.EditMenuItem={'title':'编辑','control_type':'MenuItem'}
            self.DeleteMenuItem={'title':'刪除','control_type':'MenuItem','auto_id':'XMenuItem'}
            self.SearchMenuItem={'title':'搜一搜','control_type':'MenuItem'}
            self.QuoteMeunItem={'title':'引用','control_type':'MenuItem'}
            self.SelectMenuItem={'title':'多選','control_type':'MenuItem'}
            self.EnlargeMeunItem={'title':'放大閱讀','control_type':'MenuItem'}
            self.FindInChatMenuItem={'title':'定位到聊天位置','control_type':'MenuItem'}
            self.CopyLinkMenuItem={'title':'複製連結','auto_id':'XMenuItem','control_type':'MenuItem'}
            self.VoiceToTextMenuItem={'title':'語音轉文字','control_type':'MenuItem'}
